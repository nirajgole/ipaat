/*
You are given a list of movies along with their genre in one table and
ratings for each movie in another table.
Write SQL to find movies with the highest average rating in each genre and
then print the average rating starts(nearest whole number)
*/
-- create movies table
CREATE TABLE movies (
id INT PRIMARY KEY,
